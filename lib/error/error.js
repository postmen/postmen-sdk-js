...
class PostmenError {
	 ...
	 * @constructor
	 */
	static getRequestError(error, error_data) {
	...
	/**
	 * Static Method for getting server side error
	 *
	 * @constructor
	 */
	static getServerSideError() {
		let error = new Error();
		error.message = 'Something went wrong on server side';
		error.code = 500;
